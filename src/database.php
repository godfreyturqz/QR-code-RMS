...
<div class="row m-0">
    ...
    <main class="col p-0">
        ...
        <!--cards-->
        <div class="d-flex justify-content-center fadeIn mt-4" style="display:none;">
            <div class="col-3 bg-white p-4 m-2 shadow-lg rounded-lg" style="width:250px;">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-4"></div>
                    <div class="col"><h1 class="font-weight-bold"><?= countRegTotal(); ?></h1></div>
                </div>
            </div>
            <div class="col-3 bg-white p-4 m-2 shadow-lg rounded-lg" style="width:250px;">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-4"></div>
                    <div class="col"><h1 class="font-weight-bold"><?= countPatientTotal(); ?></h1></div>
                </div>
            </div>
            <div class="col-3 bg-white p-4 m-2 shadow-lg rounded-lg" style="width:250px;">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-4"></div>
                    <div class="col"><h1 class="font-weight-bold"><?= countAdminTotal(); ?></h1></div>
                </div>
            </div>
            <div class="col-3 bg-white p-4 m-2 shadow-lg rounded-lg" style="width:250px;">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-4"></div>
                    <div class="col"><h1 class="font-weight-bold"><?= countOthersTotal(); ?></h1></div>
                </div>
            </div>
        </div>
        <!--table container-->
            ...
            <table id="table" class="table table-hover bg-white">
                ...
                <div class="d-flex bg-white p-3 mb-2 rounded-lg">
                    <div class="d-flex align-items-center mr-auto ">
                        <!-- home buttons -->
                        <div class="mr-3">
                            <a href="index.php"><button class="btn border"><i class="fa fa-home fa-lg text-primary"></i></button></a>
                            <a href="database.php?page=1&limitRecords=10"><button class="btn border"><i class="fa fa-refresh fa-lg text-primary"></i></button></a>
                        </div>
                        <!--search bar-->
                        <div class="mr-3">
